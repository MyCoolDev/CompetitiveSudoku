...
class LogRegister(BaseState):
    ...
    def __init_vars(self, *args, **kwargs) -> None:
        ...
        self.password_textbox = TextBox(pygame.Vector2(self.screen.get_width() / 3, 60), pygame.Vector2(self.screen.get_width() / 3, 3.5 * self.screen.get_height() / 7), (30, 30, 30), "Enter Password", "Light", 16, (193, 193, 193), padding_left=20, padding_right=20, border_radius=25, hidden=True)
        ...
        self.username_textbox = TextBox(pygame.Vector2(self.screen.get_width() / 3, 60), pygame.Vector2(self.screen.get_width() / 3, 2.5 * self.screen.get_height() / 7), (30, 30, 30), "Enter Username", "Light", 16, (193, 193, 193), padding_left=20, padding_right=20, border_radius=25, next_input=self.password_textbox)
